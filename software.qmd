...
**eDNAjoint**: R package useful for interpreting observations from paired eDNA and traditional surveys. Available on [Cran](https://cran.r-project.org/web/packages/eDNAjoint/index.html) (stable version) and [ROpenSci](https://github.com/ropensci/eDNAjoint) (development version). Refer to the [package vignette](https://ednajoint.netlify.app/) and [MEElive! webinar](https://www.youtube.com/watch?v=_fBllgza4jU) for more information and detailed examples. Peer-reviewed at *ROpenSci*. Silver statistical software badge.
:::
