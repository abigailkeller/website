...
**eDNAjoint**: R package useful for interpreting observations from paired eDNA and traditional surveys. [Development version](https://github.com/abigailkeller/eDNAjoint). In review at *ROpenSci*.
:::
